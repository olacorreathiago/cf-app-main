-- WOD access now requires a confirmed check-in (bookings.attended = true).
-- get_attended_class_wods previously returned WODs for any class id passed in;
-- it now only returns WODs for classes where the calling user has a confirmed
-- booking AND was marked present by the coach.
